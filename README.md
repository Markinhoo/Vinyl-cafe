...
- Pulsa **Q** mirando una funda de artista para tomar ese disco.
...
- Mantén clic izquierdo sobre el fader derecho y arrastra verticalmente para controlar el volumen.
- Usa los botones pequeños de la izquierda para seleccionar 45 RPM (lenta), 33⅓ RPM (normal) o 78 RPM (rápida).
